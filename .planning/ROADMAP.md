...
- [ ] **Phase 0: Foundation, Sound & Localization** - Stable infrastructure, audio feedback, and bilingual support
...
**Success Criteria** (what must be TRUE):
  ...
  2. SoundManager registers exactly once with no duplicate warnings in the output log; AudioBusLayout exists with three buses (SFX, Music, UI) properly configured
...
|-------|----------------|--------|-----------|
| 0. Foundation, Sound & Localization | 0/0 | Not started | - |
